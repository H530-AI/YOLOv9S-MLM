...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='../models/segment/yolov9-c-dseg.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/segdata.yaml', help='dataset.yaml path')
