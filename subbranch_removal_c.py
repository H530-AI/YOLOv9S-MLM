...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='./models/detect/gelan-s.yaml', help='object model.yaml path')
    parser.add_argument('--device', default='cpu', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--data', type=str, default='data/data.yaml', help='dataset.yaml path')
    parser.add_argument('--idx', type=int, default=22, help='layer number of model')
