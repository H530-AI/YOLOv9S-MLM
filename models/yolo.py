    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # TODO: channel, gw, gd
            ...
            # ----------------------------------------------------------
                   ...
                   FocalModulation, ScConv, EfficientAttention, SCSA, FRFN，MCA}:
            c1 = ch[f]
            c2 = ch[f]
            args = [c1, *args]
            ...
            c2 = c1[0]
            args = [c1]
        elif m in {RepNCSPELAN4AKConv, C3, C2f, C2f_Attention, C3Ghost, C2fGhost, DSConv, DWConv, C2fSCConv, C3SCConv,
                   RepNCSPELAN4DySnakeConv, RepNCSPELAN4LSK, RepNCSPELAN4SCConv, C3Attention, C3ScConv, C2fScConv,
                   RepNCSPELAN4iRMB, Rep_SC_Atten, C2f_LSK, C3_LSK, RepNCSPELAN4_CD_LSK, C3_CD_LSK, C2f_CD_LSK, C3_KAN,
                   C2f_KAN, C2f_DCNv4, C3_DCNv4, RepNCSPELAN4DCNv4, C2f_DCNv2, C3_DCNv2, RepNCSPELAN4DCNv2, C2f_DCNv3,
                   C3_DCNv3, RepNCSPELAN4DCNv3, RepNCSPELAN4_KAN, C2f_ConvMod, C3_ConvMod, RepNCSPELAN4_ConvMod,
                   C2f_MDHTA, C3_MDHTA, RepNCSPELAN4_MDHTA, C2f_RCBv6, RepNCSPELAN4_RCBv6, C2f_MLKA_Ablation,
                   C3_MLKA_Ablatio, C3_RCBv6, C3_gnconv, C2f_gnconv, RepNCSPELAN4_gnconv,
                   PKIStage, PKIBlock, HLFDB, MetaNeXt, ConvNeXt, InceptionNeXtBlock}:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
        elif m in {DySnakeConv, GhostConv, InceptionV1, InceptionV2a, InceptionV2b, InceptionV2c, SCConv, WordEmbed,
                   EmbedMerging, SwinStage, MobileNetV1, InceptionV3a, InceptionV3b, InceptionV3c, InceptionV3d,
                   InceptionV3e, InceptionA, InceptionB, InceptionC, RedutionA, RedutionB, GhostInceptionV1,
                   GhostInceptionV2c, GhostInceptionV2a, GhostInceptionV2b, DepthwiseSepConvBlock, FEM
                   }:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, *args]
